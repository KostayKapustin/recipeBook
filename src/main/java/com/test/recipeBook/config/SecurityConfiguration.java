...
import com.test.recipeBook.security.JWTAuthenticationFilter;
import com.test.recipeBook.security.JWTLoginFilter;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected AuthenticationManager authenticationManager() throws Exception {
        return new ProviderManager(Arrays.asList( new AuthenticationProviderImpl(redisService)));
    }
